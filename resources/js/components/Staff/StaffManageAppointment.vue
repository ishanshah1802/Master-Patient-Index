            ...
            Logout <i class="fas fa-power-off"></i>
                ...
                <ul class="breadcrumb navbar navbar-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <router-link to="/staffmanageappointment" class="text-decoration-none text-muted">Manage
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 mt-3">
                                        ...
                                        <table class="table table-hover table-bordered table-striped table-sm">
                                            <thead class="text-md">
                                                <tr>
                                                    ...
                                                    <th width="8%">
                                                        <a href="#"
                                                            @click.prevent="updateSorting('appointment_id')">App.
                                                            ID</a>
                                                    ...
                                                    <th width="8%">
                                                        <a href="#" @click.prevent="updateSorting('patient_id')">Patient
                                                            ID</a>
                                                        <span v-if="sort_field == 'patient_id' ? 1 : 0">
                                                            <span v-if="sort_direction == 'asc' ? 1 : 0">&uarr;</span>
                                                            <span v-if="sort_direction == 'desc' ? 1 : 0">&darr;</span>
                                                        </span>
                                                    </th>
                                                    <th width="15%">
                                                        <a href="#"
                                                            @click.prevent="updateSorting('patient_name')">Patient
                                                            Name</a>
                                                        <span v-if="sort_field == 'patient_name' ? 1 : 0">
                                                            <span v-if="sort_direction == 'asc' ? 1 : 0">&uarr;</span>
                                                            <span v-if="sort_direction == 'desc' ? 1 : 0">&darr;</span>
                                                        </span>
                                                    </th>
                                            ...
                                            <tbody class="text-md" v-for="(appointment, index) in appointments.data"
                            ...
                            <div class="card card-primary" v-if="editAppointmentId == -1 ? 0 : 1">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <button type="button" class="btn btn-tool" @click="closeEditAppointment">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>Patient ID <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Patient ID"
                                                        v-model="editPatientId" required disabled />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <label>Patient Name <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Patient Name"
                                                        v-model="editPatientName" disabled />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <label>Current Date <span class="required-mark"
                                                        style="color: red;">*</span> </label>
                                                <div class="input-group">
                                                    <input type="date" class="form-control" placeholder="dd/mm/yyyy"
                                                        v-model="editCurrentDate" disabled />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>Date of Birth <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="date" class="form-control" placeholder="Birth Date"
                                                        v-model="editPatientDOB" disabled />
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <label>Age <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Age" disabled
                                                        v-model="editPatientAge" required />
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Appointment Date <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="date" class="form-control" placeholder="dd/mm/yyyy"
                                                        v-model="editAppointmentDate" required />
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Appointment Time <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                                    <input type="time" class="form-control"
                                                        v-model="editAppointmentTime" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>Medical Department <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <div class="input-group">
                                            ...
                                            <div class="col-lg-4">
                                                <label>Symptoms <span class="required-mark"
                                                        style="color: red;">*</span></label>
                                                <textarea class="form-control" rows="1" placeholder="Symptoms"
                                                    style="resize: none" v-model="editSymptoms"></textarea>
                                            </div>
                                            <div class="col-lg-4">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary text-md" @click="updateAppointment">
                                        Update
                                    </button>
...
export default {
    ...
    methods: {
        getAllAppointments: function (page = 1) {
            axios
                .get("../api/staffmanageappointment?page=" +
                    page +
                    "&paginate=" +
                    this.paginate +
                    "&search=" +
      ...
      swal
        ...
        editAppointment: function (
            ...
            axios
                .get("../api/staffsidegetpatient/" + patient_id)
                .then((response) => {
